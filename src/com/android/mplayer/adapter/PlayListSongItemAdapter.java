...
import com.android.mplayer.listener.SongOuttoPlayListListener;
import com.android.mplayer.utils.LoadSmallImageUtil;

public class PlayListSongItemAdapter extends BaseAdapter{
	...
	public PlayListSongItemAdapter(Context context,List<Mp3Info> musiclist,long id) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		quick_context_tip.setOnClickListener(new SongOuttoPlayListListener(context,mp3Info.getId(),id));
		return convertView;
	}
